...
describe('Tuning', () => {
  ...
  it('finds the nearest tone', () => {
    const nearestG0 = edo12.nearestTone(Tone.fromPitch(edo12, 7));
    ...
    const nearestG1 = edo12.nearestTone(new Tone(edo12, 7, 1));
    ...
    const nearestGm1 = edo12.nearestTone(Tone.fromPitch(edo12, -5));
    ...
    const nearestGp0 = edo12.nearestTone(Tone.fromPitch(pyth12, 7));
    ...
    const nearestGp1 = edo12.nearestTone(new Tone(edo12_fudged, 1, 1));
    ...
    const nearestGp2 = edo12.nearestTone(new Tone(rast, 1, 1));
